                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="course_name" value="<?php echo $res['terms_title'];?>"class="form-control" placeholder="Enter course name">
                                    </div>
                                </div>
...
<?php
		if(isset($_POST['submit']))
		{
			...
			$sql="update `terms_master` set `terms_title`='$course' where `terms_id`=$id ";
			$k=mysqli_query($conn,$sql);
			
			if($k==1 )
			{
				echo "<script>alert('Data Successfully Updated..');window.location.href='index.php?page=course.php';</script>";
