        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="master_student.php?page=notice.php">
                            <i class="material-icons">notifications</i>
                            <span>View Notice</span>
                        </a>
                    </li>
					<li>
                        <a href="master_student.php?page=exam.php">
                            <i class="material-icons">info</i>
                            <span>Exam Schedule</span>
                        </a>
                    </li>
					<li>
                        <a href="master_student.php?page=search.php">
					...
					<li>
                        <a href="master_student.php?page=final_result.php">
					...
					<li>
                        <a href="master_student.php?page=password.php">
