		...
		if($subject==0)
		{
		...
		else if($name==0 && $number==0)
				{
				...
				else if($name!=0 && $number!=0)
					{
						...
						{
							echo "<script>window.location.href='master_student.php?page=search_result.php&cid=$course&sid=$semester&sub_id=$subject&name=$name&sub_exam_id=$criteria&type=$type';</script>";
						}	
						else if($number!=0)
							{ 
								echo "<script>window.location.href='master_student.php?page=search_result.php&cid=$course&sid=$semester&sub_id=$subject&number=$number&sub_exam_id=$criteria&type=$type';</script>";
							}	
		}
?>
...
$("#course").change(function(){
	...
	if(type==999)
	{
		alert("Please Select Subject Type..");window.location.href='master_student.php?page=search.php';
	}
	 course=$("#course").val();
		if(course==0)
		{
			alert("Please Select Course..");window.location.href='master_student.php?page=search.php';
		}
});
