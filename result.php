...
<?php
		if(isset($_POST['submit']))
		{
			...
			if($subject==0)
			{
				echo "<script>alert('Please Select Subject..');window.location.href='index.php?page=result.php';</script>";
			}
			else	
			echo "<script>window.location.href='index.php?page=view_marks.php&cid=$course&sid=$semester&sub_id=$subject&type=$type';</script>";
		}
?>
...
$("#semester").change(function(){
	...
	if(type==999)
	{
		alert("Please Select Subject Type..");window.location.href='index.php?page=result.php';
	}
		...
		if(course==0)
		{
			alert("Please Select Course..");window.location.href='index.php?page=result.php';
		}
